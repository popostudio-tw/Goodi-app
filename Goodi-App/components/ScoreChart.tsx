...
// Optimize: Wrap in React.memo to prevent re-renders when parent state changes but scores remain the same.
const ScoreChart = React.memo<ScoreChartProps>(({ scores }) => {
    if (scores.length < 2) {
