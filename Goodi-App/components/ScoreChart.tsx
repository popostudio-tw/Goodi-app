...
// Optimized: Wrapped in React.memo to prevent unnecessary re-renders when scores prop hasn't changed.
// This is especially important as SVG rendering can be expensive.
