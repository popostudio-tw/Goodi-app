...
// Optimized: Wrapped in React.memo to prevent re-renders when parent (ParentModePage)
// re-renders due to unrelated state changes (like context updates).
const ScoreChart: React.FC<ScoreChartProps> = React.memo(({ scores }) => {
    if (scores.length < 2) {
