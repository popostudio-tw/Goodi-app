    ...
    return (
        <div className="space-y-4">
            <div className="flex flex-wrap gap-2">
                ...
                <button onClick={() => setShowAiSuggest(true)} disabled={isLocked} className="bg-purple-500 text-white px-4 py-2 rounded-lg font-bold disabled:bg-gray-300">AI 推薦</button>
                <button onClick={() => setShowAiGoal(true)} disabled={isLocked} className="bg-emerald-500 text-white px-4 py-2 rounded-lg font-bold disabled:bg-gray-300">AI 目標生成</button>
            </div>
...
const ParentModePage: React.FC<ParentModePageProps> = ({ onExit }) => {
  ...
  const handlePaymentConfirm = () => {
    if (selectedPlanForPayment) setPlan(selectedPlanForPayment);
